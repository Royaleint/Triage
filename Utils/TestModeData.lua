...
local MASTER_MEMBER_SEEDS = {
	...
	{name = "Helia", classFile = "WARLOCK", specID = 266, role = "DAMAGER", dispelType = "Magic", healthState = "full"},
	{name = "Ilya", classFile = "SHAMAN", specID = 262, role = "DAMAGER", dispelType = "Curse", healthState = "full"},
	{name = "Joren", classFile = "WARRIOR", specID = 72, role = "DAMAGER", dispelType = nil, healthState = "injured"},
	...
	{name = "Ryn", classFile = "SHAMAN", specID = 264, role = "HEALER", dispelType = "Poison", healthState = "full"},
	...
	{name = "Wes", classFile = "HUNTER", specID = 253, role = "DAMAGER", dispelType = nil, healthState = "full"},
	...
	{name = "Alric", classFile = "WARRIOR", specID = 72, role = "DAMAGER", dispelType = nil, healthState = "injured"},
	...
	{name = "Isla", classFile = "WARLOCK", specID = 266, role = "DAMAGER", dispelType = "Poison", healthState = "injured"},
...
local function CreateMember(seed, index)
	local member = {
		...
		currentPower = 100000,
		maxPower = 100000,
		inRange = seed.healthState ~= "offline",
