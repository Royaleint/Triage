...
L["resetSpecDefaults_desc"] = "Reset all indicator settings, then apply the curated aura defaults for your current specialization."
...
L["Spec aura defaults reset."] = "%d indicator slot(s) reset. %d customized slots skipped."
L["resetSpecDefaults_confirm"] = "Are you sure you want to reset ALL indicator settings and aura lists for this character?"
...
L["dispelWildcard_desc"] = "any debuffs you can dispel"
...
L["Recognized"] = true
L["Wildcard"] = true
L["Inactive wildcard"] = "Recognized, but will not match on this client"
L["Unknown spell ID"] = true
L["Unverified entry"] = "Not in your spellbook — unverified (may still be valid)"
L["Did you mean format"] = "Did you mean %s?"
L["More entries format"] = "+%d more (%d flagged)"
L["Suggestions"] = true
...
L["Color by Debuff Type"] = true
L["dispelOverlayColorByType_desc"] = "When enabled, the border and glow match the debuff type (blue for Magic, purple for Curse, etc). When disabled, the glow uses Blizzard's default proc highlight."
L["Glow Style"] = true
