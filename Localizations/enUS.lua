...
L["Color by Debuff Type"] = true
L["dispelOverlayColorByType_desc"] = "When enabled, the border and glow match the debuff type (blue for Magic, purple for Curse, etc). When disabled, they use Blizzard's default dispel highlight."
L["Glow Style"] = true
